	          ...
	          <div class="col-lg-7">
	            <div class="p-5">
	              <div class="text-center">
	                <h1 class="h4 text-gray-900 mb-4">修改员工信息</h1>
	              </div>
	              
                  <form  class="user" action="manager/managerUpdateStaffInfo" action="post" enctype="mutipart/form-data">
	              	<!-- 输出的、不能修改的sid和sname -->
	              	
	              	<div class="form-group row">
                  		<div class="col-sm-6 mb-3 mb-sm-0 ">
                    		<input type="text" class="form-control form-control-user" name="s_id"   readonly="readonly" value="<%=staff1.getS_id()%>"/>
                 		</div>
                  		<div class="col-sm-6 mb-3 mb-sm-0">
                    		<input type="text" class="form-control form-control-user" name="s_name" value="<%=staff1.getS_name()%>" readonly="readonly"/>
                  		</div>
                  	</div>	
                  		 
                  	
                  		<div class="form-group">
                    		<input type="text" class="form-control form-control-user Wdate" name="entry_time"   value="<%=staff1.getEntry_time()%>" onfocus="WdatePicker({skin:'whyGreen',dateFmt: 'yyyy-MM-dd HH:mm:ss', minDate: '2005-01-01 11:00:00', maxDate: '2025-01-01 23:59:59', lang:'zh-cn' })"/>
                  		</div>
                  		
                  		<div class="form-group">
                  			<c:set var="depidNow" value="<%=staff1.getDep_id() %>"></c:set>
	                  		<select name="dep_id">
                    		...
                    		<input type="text" class="form-control form-control-user" readonly="readonly" name="dep_id"  value="<%=staff1.getDep_id()%>"/>
                  		</div>
                  		...
                  		<div class="form-group">
                    		<input type="text" class="form-control form-control-user" name="s_pass" value="<%=staff1.getS_pass()%>"/>
                  		</div>                  		
