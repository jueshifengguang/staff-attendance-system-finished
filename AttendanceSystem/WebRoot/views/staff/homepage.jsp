...
<html>
 ...
 <body  id="page-top">
  <%
  	...
  	Integer dep_id = staff.getDep_id();
    						...
    						<tr>
								...
								<td>				
 						  		 ...
 						  		 <td>
    									...
    									<a href="staff/signInShiftWork?s_id=<%=sId%>&sw_id=<%=shiftWorkToday.getSw_id()%>">打卡</a>
    								</c:if>
   					 				<c:if test="<%=shiftWorkToday.getAttendence_status() == 1 %>">
    									<a href="staff/signOffShiftWork?s_id=<%=sId%>&sw_id=<%=shiftWorkToday.getSw_id()%>">签退</a>
    								</c:if>
	              ...
	              <div class="card shadow mb-4"> 
					...
					<div class="card-body">
						<c:if test="<%=is_remind == 1 %>">
  							  已经超过下班时间1小时了，
 						   <a href="staff/insertOvertimeRecord?s_id=<%=sId%>&overtime_start=<%=shiftWorkToday.getWorking_end().toString() %>">申请加班</a>
    					</c:if>
			   		</div>  
					    ...
					    <table>
					    	...
					    	<%
					    	 ...
					    	 %>
					    	 	...
					    	 	<td><a href="staff/signInOvertime?s_id=<%=sId%>&oa_id=<%=overtimeSignIn.getOa_id()%>">打卡</a></td>
					    	 	</tr>
					    	 <%
					    	 	}
					    	  %>
					    	 ...
					    	 %>
					    	 	...
					    	 	<td><a href="staff/signOffOvertime?s_id=<%=sId%>&oa_id=<%=overtimeSignOff.getOa_id()%>">签退</a></td>
					    	 	</tr>
					    	 <%
					    	 	}
					    	  %>
