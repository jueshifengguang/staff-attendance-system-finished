...
<html>
  <head>
    ...
    <title>My JSP 'examineOvertimeApply.jsp' starting page</title>
  ...
  <body id="page-top wrapper">
  <%
  	request.setCharacterEncoding("UTF-8");
  	
  	//获得参数
  	Integer sId = Integer.parseInt(request.getParameter("s_id"));
  	Overtimeapplication selectOvertimeApply = (Overtimeapplication)request.getAttribute("selectOvertimeApply");
  	Staff applyStaff = (Staff)request.getAttribute("applyStaff");
	          ...
	          <div class="col-lg-7">
	            <div class="p-5">
	              <div class="text-center">
	                <h1 class="h4 text-gray-900 mb-4">这是审批请假记录申请的页面（部门主管的）</h1>
	              </div>
	              <form class="user" action="director/examineOvertimeApply" method="post">
	              	<!-- 隐藏域 -->
	              	<input type="hidden" name="oa_id" value="<%=selectOvertimeApply.getOa_id()%>">
	              	<input type="hidden" name="s_id" value="<%=sId%>">
	              
	              	<!-- 输出的、不能修改的sid和sname -->
	              	<div class="form-group row">
                  		<div class="col-sm-6 mb-3 mb-sm-0">
                    		<input type="text" class="form-control form-control-user" name="select_id" value="<%=applyStaff.getS_name() %>" readonly="readonly" id="exampleFirstName" placeholder="员工编号">
                 		</div>
                  		<div class="col-sm-6">
                    		<input type="text" class="form-control form-control-user" name="s_name" value="<%=applyStaff.getS_name() %>" readonly="readonly" id="exampleLastName" placeholder="员工姓名">
                  		</div>
                	</div>
	                
	                <!-- 申请的加班开始时间 -->
	                <div class="form-group">
						<input type="text" name="overtime_start" value="<%=selectOvertimeApply.getOvertime_start() %>" readonly="readonly" class="form-control form-control-user" >
	                </div>
	                <!-- 申请的加班结束时间 -->
	                <div class="form-group">
	                	<input type="text" name="overtime_end" value="<%=selectOvertimeApply.getOvertime_end() %>" readonly="readonly" class="form-control form-control-user">
	                </div>
	                
	                <!-- 申请的加班理由 -->
	                <div class="form-group">
	                	<input type="text" name="overtime_reason" value="<%=selectOvertimeApply.getOvertime_reason() %>" readonly="readonly" class="form-control form-control-user">
	                </div>
	                ...
	                <div class="form-group row">
	    				...
	    				<div class="col-1">
	    					<input type="radio" name="is_approved" value="1" checked="checked" class="form-control" style="weight:25px;height:25px">
	    				</div>
	    				<div class="col-2" style="margin-left:80px;">不同意</div>
	    				<div class="col-1">
	    					<input type="radio" name="is_approved" value="2" class="form-control" style="weight:25px;height:25px">
	    				</div>
	                </div>
	                
	                <!-- 填写审批意见 -->
	                <div class="form-group">
	                	<input type="text" name="examination" class="form-control form-control-user" placeholder="审批意见">
	                </div>
	                ...
	                <hr>
	                <a href="director/selectNoncheckedOvertimeApply?s_id=<%=sId%>" class="btn btn-primary btn-user btn-block">
	                 	 返回
	                </a>
	              </form>
