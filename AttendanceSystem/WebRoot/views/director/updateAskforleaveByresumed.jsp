  ...
  <% 
        Integer sId = 0;
  		if(request.getParameter("s_id") != null){
  		 ...
  		 Integer is_approved = 12;
   		if(request.getParameter("is_approved") != null){
   			is_approved = Integer.parseInt(request.getParameter("is_approved"));
   		}
  		...
  		String  approved_reason = "null";
  		if(updateAfl.getApproved_reason() != null){
  			approved_reason = updateAfl.getApproved_reason();
  		}
	          ...
	          <div class="col-lg-7">
	            <div class="p-5">
	              <div class="text-center">
	                <h1 class="h4 text-gray-900 mb-4">销假</h1>
	              </div>
	              
	              <form action="director/updateAskforleaveByresumed" method="post"> 
	              <input type="hidden" name="afl_id" value="<%=afl_id%>">
	              <div class="form-group row">
  						<div class="col-sm-6 mb-3 mb-sm-0">
  								<input type="text" class="form-control form-control-user" readonly="readonly" name="s_id" value="<%=sId%>" placeholder="员工编号">
  						</div>
  				
  						<div class="col-sm-6">
                    		<input type="text" class="form-control form-control-user" name="s_name" value="<%=login_staff.getS_name()%>" readonly="readonly" placeholder="员工姓名">
                  		</div>
                 </div>
                 <div class="form-group row">
                  		<div class="col-sm-6">
  				 ...
  				 <div class="form-group row">
                  		<div class="col-sm-6">
                    		请假类型：<input type="text" readonly="readonly" class="form-control form-control-user" name="leave_type" value="<%=leave_type%>">
                  		</div>
                  		<div class="col-sm-6">                    		    
                  			请假原因：<input type="text" readonly="readonly" class="form-control form-control-user" name="leave_reason" value="<%=leave_reason%>">				
  						</div> 
  				</div>				
  				 <div class="form-group row">
                  		<div class="col-sm-6">
                    		审批状态：<input type="text" readonly="readonly" class="form-control form-control-user" name="is_approved" value="<%=is_approved%>">
                  		</div>
                  		<div class="col-sm-6">                    		    
                  			审批原因：<input type="text" readonly="readonly" class="form-control form-control-user" name="approved_reason" value="<%=approved_reason%>">						
  						</div> 
  				</div>
	            <div class="form-group">
	                	请选择是否通过：<input type="radio" checked="checked" name="is_resumed" value="1" />销假
    									<input type="radio"  name="is_resumed" value="0" />放弃销假 
	            </div> 
	             <div class="form-group">
