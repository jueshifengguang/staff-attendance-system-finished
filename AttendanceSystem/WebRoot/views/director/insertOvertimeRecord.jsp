	          ...
	          <div class="col-lg-7">
	            <div class="p-5">
	              <div class="text-center">
	                <h1 class="h4 text-gray-900 mb-4">新增加班申请的页面（部门主管的）</h1>
	              </div>
	              <form class="user" action="director/insertOvertimeDB" method="post">
	              	<!-- 输出的、不能修改的sid和sname -->
	                ...
	                <hr>
	                <a href="director/selectOvertimeRecord?s_id=<%=sId%>" class="btn btn-primary btn-user btn-block">
	                 	 返回
	                </a>
	              </form>
