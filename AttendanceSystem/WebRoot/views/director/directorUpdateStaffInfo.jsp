   ...
   <!-- Page Heading -->
     <div class="container">
	    ...
	    <div class="card o-hidden border-0 shadow-lg my-5">
          ...
          <form  class="user" action="director/directorUpdateStaffInfo" action="post" enctype="mutipart/form-data">
    	 <div class="form-group">
           <input type="text" class="form-control form-control-user Wdate" name="s_pass"/>
         </div>
         <div class="form-group">
